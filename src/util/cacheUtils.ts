/**
 * Utility file provided by RTK-Query. This file contains helper functions for API endpoints.
 ...
 */
export type CacheList<T, ID> = Array<CacheItem<T, "LIST"> | CacheItem<T, ID> | DefaultTags>;

/**
 * Inner function returned by `providesList` to be passed to the `provides` property of a query
 */
type InnerProvidesList<T> = <Results extends Array<{ id: unknown }>, Error extends FetchBaseQueryError>(
